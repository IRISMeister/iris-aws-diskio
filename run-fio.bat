...
fio --name=randw --iodepth=1 --rw=randwrite --bs=8k --direct=1 --size=1g --numjobs=1 --thread -group_reporting --iopsavgtime=1000 > rndwrite-1.txt
fio --name=randw --iodepth=1 --rw=randwrite --bs=8k --direct=1 --size=1g --numjobs=4 --thread -group_reporting --iopsavgtime=1000 > rndwrite-4.txt
...
fio --name=randr --iodepth=1 --rw=randread --bs=8k --direct=1 --size=1g --numjobs=1 --thread -group_reporting --iopsavgtime=1000 > rndread-1.txt
fio --name=randr --iodepth=1 --rw=randread --bs=8k --direct=1 --size=1g --numjobs=4 --thread -group_reporting --iopsavgtime=1000 > rndread-4.txt
